...
export function HeroSection() {
  ...
  return (
    <section
      id="inicio"
      className="relative min-w-0 scroll-mt-[5.5rem] overflow-hidden bg-transparent pt-24 sm:pt-28"
    >
      <div className="mx-auto w-full min-w-0 max-w-6xl lg:px-8">
        <div className="grid items-stretch lg:grid-cols-12 lg:gap-10">
          ...
          >
            <div className="relative h-[min(340px,72vw)] sm:h-[420px] md:h-[520px] lg:h-[min(720px,calc(100svh-5rem)))]">
          ...
          <div className="relative order-1 lg:order-1 lg:col-span-5">
            <Container className="py-6 sm:py-12 lg:px-0">
              ...
              <motion.h1
                className="mt-0 font-display text-[2.2rem] leading-[1.05] tracking-tight text-studio-950 min-[400px]:text-[2.55rem] sm:mt-2 sm:text-6xl lg:mt-0"
              ...
              >
                <img
                  ...
                  className="h-[56px] w-[min(420px,100%)] object-contain sm:h-[72px]"
                  loading="lazy"
                />
              ...
              <motion.div
                className="mt-6 flex flex-wrap gap-1.5 sm:mt-10 sm:gap-2"
